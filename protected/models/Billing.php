...
class Billing extends \yii\db\ActiveRecord
{
    ...
    // public static function getDueDate($period, $type)
    // {
    //     $currentDate = date("Y-m-d");
    //     return date("Y-m-d", strtotime("+" . $period . " day", strtotime($currentDate)));
    // }
    ...
    public static function getDueDate($period, $type)
    {
        ...
        for ($i = 0; $i < $period; $i++) {
            ...
            // if type is work day
            if ($type == QuotationTc::GRACE_TYPE_WORK_DAY) {
