...
$this->title = 'Create Alteration Refund - ' . Yii::$app->name;
?>

<div class="alteration-refund-create">
    <div class="row mb-4">
        <div class="col-md-6">
            <h2 class="p-0 m-0">Create Alteration Refund</h2>
        </div>
        <div class="col-md-6 my-auto">
            <?= Html::beginForm(['alteration-refund/create'], 'post', ['id' => 'alteration-refund-form', 'class' => 'form-inline']) ?>
    ...
    ?>
        <?= Html::beginForm(['alteration-refund/create'], 'post', ['id' => 'alteration-refund-member-form']) ?>
        ...
        $.ajax({
            ...
            success: function(data){         
                if (data.member_no != null) {
                    ...
                    html += '<td><input type="text" class="form-control dtpckr" name="new_end_dates[]" value="' + data.end_date + '"></td></td>';
            ...
            success: function(data){
                ...
                for (var i = 0; i < len; i++) {
                    if (data[i].member_no != null) {
                        ...
                        html += '<td><input type="text" class="form-control dtpckr" name="new_end_dates[]" value="' + data[i].end_date + '"></td></td>';
