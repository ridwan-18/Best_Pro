...
$this->title = 'Print Credit Note Cancel';
?>
...
<section class="sheet padding-10mm credit-note">
    ...
    <table width="100%">
        <tr>
            <td><b>No: <?= $AlterationCancel['alteration_no']; ?></b></td>
            <td align="right"><b>Jakarta, <?= Utils::convertDateTodMyPrint($AlterationCancel['alteration_date']); ?></b></td>
        </tr>
    </table>
    <br>
    <p><b>Kepada Yth:</b></p>
    ...
    <table width="100%" class="price-list">
        ...
        <tr>
            <td style="border-top: none; border-bottom: none">
                Pembatalan Kepesertaan Asuransi produk <?= $product['name']; ?>
                dengan nomor Polis <?= $policy['policy_no']; ?> dan jumlah peserta
                <?= $cancelMember['total_member']  ; ?> orang 
                <br><br><br>
            </td>
            <td style="border-top: none; border-bottom: none" align="right">
			 <?= number_format($AlterationCancel['total_premium']) ; ?> 
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                Terbilang : <?= Utils::numberToText($AlterationCancel['total_premium']); ?> Rupiah
            </td>
        </tr>
    </table>
...
<section class="sheet padding-10mm member-approval">
    <table width="100%">
        <tr>
            <td width="55%" valign="top">Jakarta, <?= Utils::convertDateTodMyPrint($AlterationCancel['alteration_date']); ?></td>
            <td>
                <table>
                    <tr>
                        <td width="75">Nomor</td>
                        <td width="10">:</td>
                        <td><?= $AlterationCancel['reg_no']; ?></td>
                    </tr>
                    <tr>
                        <td>Perihal</td>
                        <td>:</td>
    ...
    <p><b>1. Daftar Pembatalan Peserta Asuransi Kumpulan</b></p>
    <div style="padding-left: 12px;">
        <table>
            ...
            <tr>
                <td>Total UP</td>
                <td>:</td>
                <td>Rp. <?= number_format($AlterationCancel['total_si']); ?></td>
            </tr>
            <tr>
                <td>Total Premi Gross</td>
                <td>:</td>
                <td>Rp. <?= number_format($AlterationCancel['total_premium']); ?></td>
            </tr>
        </table>
    </div>
    <br>
    ...
    <p>Dapat diinformasikan bahwa seluruh Peserta tersebut dalam Daftar Pembatalan Peserta Asuransi Kumpulan diberlakukan 
	efektif Pembatalan per tanggal.</p>
...
?>
    <section class="sheet padding-10mm member-list">
        <h4 class="text-center"><b>DAFTAR PEMBATALAN PESERTA ASURANSI KUMPULAN</b></h4>
        <br><br>
        <table width="100%">
            <tr>
                <td width="50%">
        ...
        <table class="detail-list">
            ...
            ?>
                <tr>
                    ...
                    <td align="right"><?= number_format($member['premi']); ?></td>
					<td align="right"><?= number_format($member['extra_premi']); ?></td>
					<td align="right"><?= number_format($member['premi']); ?></td>
                </tr>
            <?php
                $i++;
                $totalUp += $member['sum_insured'];
                $premi_cancel += $member['premi'];
				$extra_premi += $member['extra_premi'];
            endforeach;
            $grandTotalUp += $totalUp;
            $grandTotalPremi += $premi_cancel;
			$grandTotalextraPremi += $extra_premi;
            ...
            ?>
                <tr>
					...
					<th align="right"><?= number_format($grandTotalextraPremi); ?></th>
					<th align="right"><?= number_format($grandTotalPremi); ?></th>
                </tr>
            <?php
            endif;
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="30%" align="center">
                        <p>Jakarta, <?= Utils::convertDateTodMyPrint($AlterationCancel['alteration_date']); ?></p>
                        <img src="<?= $qrCodeUrl; ?>" alt="Signature" class="text-center" height="75">
                        <p><b><?= $signature->member_name; ?></b></p>
                        <p><?= $signature->member_position; ?></p>
                    </td>
