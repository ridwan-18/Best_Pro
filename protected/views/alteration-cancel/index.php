...
$this->title = 'Alteration Cancel - ' . Yii::$app->name;
?>
<div class="alteration-cancel-index">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= Html::beginForm(['alteration-cancel/index'], 'get', ['id' => 'alteration-cancel-search-form']) ?>
                    <div class="row">
                        <div class="col-md-6">
