...
<section class="sheet padding-10mm">
    <h1 class="text-center"><b>DAFTAR PESERTA DITERIMA ASURANSI KUMPULAN</b></h1>
    <br><br>
    <table width="100%">
        <tr>
            <td width="50%">
    ...
    <table class="detail-list">
        ...
        ?>
                <tr>
                    ...
                    <td align="right"><?= number_format($member['nett_premium']); ?></td>
                    <td align="center"><?= Utils::convertDateTodMy($member['stnc_date']); ?></td>
                </tr>
            <?php
                $i++;
            ...
            <tr>
                ...
                <th align="right"><?= number_format($totalEm); ?></th>
                <th align="right"><?= number_format($totalNett); ?></th>
                <th></th>
            </tr>
        <?php
        endif;
