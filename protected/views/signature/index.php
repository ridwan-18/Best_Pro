...
$this->title = 'Signature - ' . Yii::$app->name;
?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= Html::beginForm(['signature/index'], 'get', ['id' => 'signature-search-form']) ?>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <table class="table table-hover nowrap m-0">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td><?= $i; ?></td>
                                        <td><img src="<?= Url::base() . Signature::PICTURE_PATH . $model['picture']; ?>" alt="Pic" class="mb-2 img-thumbnail"></td>
                                        <td><?= $model['name']; ?></td>
