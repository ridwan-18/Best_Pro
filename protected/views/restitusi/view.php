    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= Html::beginForm(['restitusi/view'], 'get', ['id' => 'member-search-form']) ?>
...
<div class="member-view">
    <div class="row mb-4">
        <div class="col-md-6 my-auto">
            <h2 class="p-0 m-0">Member Restitusi</h2>
                        ...
                        <?php foreach ($filecbc as $cd): ?>
                            ...
                            <tr>
								...
								<?= Html::dropDownList(
										...
										[
											'' => 'Select Action',
											'1' => 'Restitusi Register',
											'2' => 'Restitusi Proses',
											'3' => 'Restitusi Diterima',
											'4' => 'Restitusi Ditolak',
											'5' => 'Restitusi Dibayar',
											'6' => 'Menunggu Kelengkapan Dokumen',
										],
										[
