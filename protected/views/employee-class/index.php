...
$this->title = 'Employee Class - ' . Yii::$app->name;
?>
<div class="employee-class-index">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= Html::beginForm(['employee-class/index'], 'get', ['id' => 'employee-class-search-form']) ?>
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <h2 class="p-0 m-0">Employee Class</h2>
        </div>
