...
$this->title = 'Claim Reason - ' . Yii::$app->name;
?>
<div class="claim-reason-index">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= Html::beginForm(['claim-reason/index'], 'get', ['id' => 'claim-reason-search-form']) ?>
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <h2 class="p-0 m-0">Claim Reason</h2>
        </div>
