...
$this->title = 'Reassuradur - ' . Yii::$app->name;
?>
<div class="reassuradur-index">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= Html::beginForm(['reassuradur/index'], 'get', ['id' => 'reassuradur-search-form']) ?>
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <h2 class="p-0 m-0">Reassuradur</h2>
        </div>
