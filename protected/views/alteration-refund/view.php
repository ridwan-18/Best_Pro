...
$this->title = 'View Alteration Refund - ' . Yii::$app->name;
?>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 text-right my-auto">
            <?= Html::a(
                ...
                [
                    'alteration-refund/approve',
                    'alteration_no' => $model->alteration_no,
                ],
                [
                    'class' => ($model->status == AlterationRefund::STATUS_APPROVED)
