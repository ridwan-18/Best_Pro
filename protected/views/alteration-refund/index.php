...
$this->title = 'Alteration Refund - ' . Yii::$app->name;
?>
<div class="alteration-refund-index">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= Html::beginForm(['alteration-refund/index'], 'get', ['id' => 'alteration-refund-search-form']) ?>
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div class="row mb-4">
		...
		<?= Html::a('<i class="fa fa-upload"></i> Upload', ['import'], ['class' => 'btn btn-primary waves-effect waves-light']); ?>
