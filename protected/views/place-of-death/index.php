...
$this->title = 'Place of Death - ' . Yii::$app->name;
?>
<div class="place-of-death-index">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= Html::beginForm(['place-of-death/index'], 'get', ['id' => 'place-of-death-search-form']) ?>
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <h2 class="p-0 m-0">Place of Death</h2>
        </div>
