        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= Html::beginForm(['billing/index'], 'get', ['id' => 'billing-search-form']) ?>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?= Utils::convertDateTodMy($model['invoice_date']); ?></td>
                                        <td><?= Utils::convertDateTodMy($model['due_date']); ?></td>
