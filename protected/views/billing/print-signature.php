...
<section class="sheet padding-10mm debit-note">
    ...
    <table width="100%" class="price-list">
        ...
        <tr>
            ...
            <td style="border-top: none; border-bottom: none">Rp. <?= ($billing['gross_premium'] == 0) ? '-' : number_format($billing['extra_premium']); ?></td>
        </tr>
        <tr>
    ...
    <?php
    } else if ($billing['policy_no'] == '1032309000612') {
    ?>
        <table>
            <tr>
                <td width="100">Bank</td>
