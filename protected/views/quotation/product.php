...
use app\models\SiType;

$products = Product::find()->orderBy(['name' => SORT_ASC])->all();
$products = ArrayHelper::map($products, 'id', 'name');

$premiumTypes = PremiumType::premiumTypes();
$productRateTypes = ProductRateType::productRateTypes();
$periodTypes = PeriodType::periodTypes();
$siTypes = SiType::siTypes();

$this->title = 'Quotation Product - ' . Yii::$app->name;
?>

<div class="modal fade create-product-modal" role="dialog" aria-labelledby="myMediumModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="myMediumModalLabel">Create Product</h4>
            </div>
            <div class="modal-body">
                <?= Html::beginForm(['quotation/create-product'], 'post', ['id' => 'product-form']) ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?= Html::dropDownList('product_id', null, $products, [
                        ...
                        <div class="form-group">
                            ...
                            <?= Html::dropDownList('premium_type', null, $premiumTypes, [
                        ...
                        <div class="form-group">
                            ...
                            <?= Html::dropDownList('rate_type', null, $productRateTypes, [
                        ...
                        <div class="form-group">
                            ...
                            <?= Html::dropDownList('period_type', null, $periodTypes, [
                        ...
                        <div class="form-group">
                            ...
                            <?= Html::dropDownList('si_type', null, $siTypes, [
...
<div class="quotation-create">
    <div class="row mb-4">
        <div class="col-md-6">
            <h2 class="p-0 m-0">Quotation Product</h2>
