...
class RestitusiController  extends Controller
{
	...
	public function actionIndex()
	{
		...
		$totalModel = Restitusi::countAllDataproduksi($paramsGetAllProduksi);

		$pagination = new Pagination([
			'totalCount' => $totalModel,
			'pageSize' => Restitusi::PAGE_SIZE,
			'pageSizeParam' => false,
		]);
		...
		$models = Restitusi::getAllProductionParticipant($paramsGetAllProduksi);
	...
	public function actionView($id)
	{
		...
		// $totalMember = Restitusi::countAllDataproduksi($params);
