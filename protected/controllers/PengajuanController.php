		...
		if ($plafond > $maxup) {
			...
			return [
				'Result' => [
					'status_code' => 200,
					'kode_response' => "08",
					'message' => 'Plafond pada produk ini melebihi limit. '
						. 'Maksimal plafond pada produk ini: Rp ' . $maxup . '.'
				]
			];
		}
			...
			$fileName =
				...
				return [
					'Result' => [
						...
						'kode_response' => '01',
						'message' =>
							'Terjadi kesalahan saat memproses pengajuan restitusi',
						'jenis_pengajuan' => 'RESTITUSI',
						'restitusi_jiwa' => [
							'status_restitusi' => '0'
						],
	...
	public function actionSubmitClaim()
{
        ...
        if ($idAgunan === '') {
            ...
            return [
                'Result' => [
                    ...
                    'kode_response' => '01',
                    'message' =>
                        'Field id_agunan wajib diisi jika benefit = 4 (Kebakaran)'
                ]
            ];
        }
    ...
    if ((int)$lockResult !== 1) {
        ...
        return [
            'Result' => [
                ...
                'kode_response' => '99',
                'message' =>
                    'Gagal mendapatkan lock proses claim',
                'status_claim' => '0'
            ]
        ];
    }
    ...
    try {
        ...
        if ($model === null) {
            ...
            Yii::info(
                'claim_riau tidak ditemukan. INSERT. ' .
                'no_akad=' . $noAkad,
                'claim-sftp'
            );
            ...
            $model =
                new \app\models\claim_riau();

        } else {

            Yii::info(
                'claim_riau ditemukan. UPDATE. ' .
                'no_akad=' . $noAkad .
                ', id=' . $model->id,
                'claim-sftp'
            );
