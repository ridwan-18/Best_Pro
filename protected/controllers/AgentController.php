...
class AgentController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $totalModel = Agent::countAll($params);

        $pagination = new Pagination([
            'totalCount' => $totalModel,
            'pageSize' => Agent::PAGE_SIZE,
            'pageSizeParam' => false,
        ]);
    ...
    public function actionCreate()
    {
        ...
        $agent = Agent::findOne(['name' => $model->name]);
        if ($agent != null) {
            Yii::$app->session->setFlash('error', "Agent already exist");
            return $this->render('create', [
                'model' => $model,
            ]);
        }
