...
class MemberController extends Controller
{
	...
	public function actionTemplate()
	{
		...
		$objPHPExcel->getActiveSheet()->setCellValue('C1', 'No Ktp');
		...
		$objPHPExcel->getActiveSheet()->setCellValue('G1', 'Tanggal Mulai Asuransi');
		$objPHPExcel->getActiveSheet()->setCellValue('H1', 'Tanggal Akhir Asuransi');
		$objPHPExcel->getActiveSheet()->setCellValue('I1', 'Uang Pertanggungan');
		$objPHPExcel->getActiveSheet()->setCellValue('J1', 'Tinggi Badan');
		$objPHPExcel->getActiveSheet()->setCellValue('K1', 'Berat Badan');

		$objPHPExcel->getActiveSheet()->getComment('B1')->getText()->createTextRun('Name cannot be blank');
		...
		$objPHPExcel->getActiveSheet()->getComment('G1')->getText()->createTextRun('Set Format Cell to date');
		$objPHPExcel->getActiveSheet()->getStyle('G1')->getFont()->setBold(true);
		$objPHPExcel->getActiveSheet()->getStyle('G:G')->getNumberFormat()->setFormatCode('yyyy-mm-dd');
		$objPHPExcel->getActiveSheet()->getComment('H1')->getText()->createTextRun('Set Format Cell to date');
		$objPHPExcel->getActiveSheet()->getStyle('H1')->getFont()->setBold(true);
		$objPHPExcel->getActiveSheet()->getStyle('H:H')->getNumberFormat()->setFormatCode('yyyy-mm-dd');
		$objPHPExcel->getActiveSheet()->getComment('I1')->getText()->createTextRun('Uang pertanggungan must be a number');
		$objPHPExcel->getActiveSheet()->getStyle('I1')->getFont()->setBold(true);
		$objPHPExcel->getActiveSheet()->getComment('J1')->getText()->createTextRun('Tinggi Badan must be a number');
		$objPHPExcel->getActiveSheet()->getStyle('J1')->getFont()->setBold(true);
		$objPHPExcel->getActiveSheet()->getComment('K1')->getText()->createTextRun('Berat Badan must be a number');
